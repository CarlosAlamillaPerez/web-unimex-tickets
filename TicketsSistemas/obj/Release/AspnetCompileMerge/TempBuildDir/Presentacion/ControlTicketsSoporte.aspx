        ...
        <ContentTemplate>
            <div class="container mt-5">
                <div class="row">
                    ...
                    <!-- Pantalla Nuevo Ticket  tm-content-row-->
                    <div class="col-sm-3 col-md-2 col-lg-3 col-xl-3" style="border-right: solid; border-right-color: #ccc;">
                                    ...
                                    <div class="wrapper">
                                      <div class="file-upload">
                                        ...
                                        <i class="fa fa-arrow-up" id="mensaje2">      Seleccionar archivo...</i>
                                          <%--<label class="file-return" id="mensaje">Seleccionar archivo...</label>--%>
                                      </div>
                                       
                                    </div>             
                                </div>
                                <div class="col-md-10 col-5">
                                    <%--<p class="file-return" id="mensaje"></p>--%>
                    ...
                    <!-- GridView Principal -->
                    <div class="col-sm-9 col-md-10 col-lg-9 col-xl-9">
                            ...
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="auto" Height="330px" CssClass="BorderGridView">
                                <asp:GridView ID="gv_CerrarTicket" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Plantel" HeaderStyle-CssClass="ColumnHeader" FooterStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_cerrar_nombre_empresa" runat="server" Text='<%#Bind("cerrar_nombre_empresa") %>' Enabled="false" Visible="true" CssClass="label" />
                                            </ItemTemplate>
                                            <ControlStyle ForeColor="Black" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Detalle" HeaderStyle-CssClass="ColumnHeader" FooterStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-gradient-primary">
            <h5 class="modal-title" id="exampleModalLabel">DETALLE TICKET # <asp:Label ID="lblIDTicket" runat="server" Text="0"></asp:Label></h5>
